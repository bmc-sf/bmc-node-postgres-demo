...
app.get('/Demo', function (req, res){
	res.writeHead(200, { 'Content-Type': 'text/html' });
	res.write('<h1>Eds DEMO:  Heroku Node.js, PostgreSQL and Heroku Connect app v1.3</h1><br/><br/><strong>Update Student Trial:  </strong><a href="http:\/\/bmc-node-postgres-demo.herokuapp.com\/updateTrial">http:\/\/bmc-node-postgres-demo.herokuapp.com\/update</a></br></br> <strong>Update Student Good: </strong><a href="http:\/\/bmc-node-postgres-demo.herokuapp.com\/updateGood">http:\/\/bmc-node-postgres-demo.herokuapp.com\/update2</a></br></br><strong>Update Student Better: </strong><a href="http:\/\/bmc-node-postgres-demo.herokuapp.com\/updateBetter">http:\/\/bmc-node-postgres-demo.herokuapp.com\/update2</a></br></br><strong>Update Student Best:  </strong><a href="http:\/\/bmc-node-postgres-demo.herokuapp.com\/updateBest">http:\/\/bmc-node-postgres-demo.herokuapp.com\/update2</a></br></br><strong>Update Student Inactive: </strong><a href="http:\/\/bmc-node-postgres-demo.herokuapp.com\/updateInactive">http:\/\/bmc-node-postgres-demo.herokuapp.com\/update2</a></br></br></br><hr><strong>View Claire:  </strong><a href="http:\/\/bmc-node-postgres-demo.herokuapp.com\/claire">http:\/\/bmc-node-postgres-demo.herokuapp.com\/harry</a></br>');
	res.end();
});
